...
![Примери меморијских операнада и разлике између mov и lea](./assets/memory-operands-and-lea.png)

*Слика пореди упис у меморију, читање вредности из меморије и рачунање адресе инструкцијом `lea`.*
